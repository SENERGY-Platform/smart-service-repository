...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/instances/{id}/maintenance-procedures": {
            "get": {
        ...
        "/instances/{id}/maintenance-procedures/{public_event_id}": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "public event id of maintenance-procedure",
        ...
        "/instances/{id}/maintenance-procedures/{public_event_id}/parameters": {
            "get": {
        ...
        "/instances/{id}/maintenance-procedures/{public_event_id}/start": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "SmartServiceParameters",
                        "name": "message",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/releases/{id}": {
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Delete all previous releases as well",
                        "name": "delete_previous_releases",
                        "in": "query"
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "model.Criteria": {
            ...
            "properties": {
                ...
                "interaction": {
                    "$ref": "#/definitions/model.Interaction"
                }
            }
        },
        "model.FilterPossibility": {
            "type": "string",
            "enum": [
                "device",
                "device_service_group",
                "group",
                "import"
            ],
            "x-enum-varnames": [
                "DeviceFilter",
                "DeviceServiceGroupFilter",
                "GroupFilter",
                "ImportFilter"
            ]
        },
        ...
        "model.IotDescription": {
            ...
            "properties": {
                ...
                "type_filter": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/model.FilterPossibility"
                    }
                }
            }
        },
